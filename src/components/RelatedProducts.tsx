...
import { POPULAR } from "../ASSETS/frontend/assets/data"
...
function RelatedProducts() {
  return (
    ...
    <hr className="h-[3px] md:w-1/2 mx-auto bg-gradient-to-r from-transparent via-black/80 to-transparent mb-16" />

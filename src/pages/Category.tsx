...
const  Category = ({category , banner} : any) => {
  return (
    <section className="max_padd_container py-12 xl:py-28">
      ...
      <div className="flexBetween max-sm:p-4 gap-x-4 px-8 py-3 rounded-5x1 ring-1 ring-slate-900/15 sicko">Sort by <MdOutlineKeyboardArrowDown /></div>
      </div>
